...
class ReportPDFGenerator:
    ...
    def build_story(self, recording: Any) -> list:
        ...
        role_name = recording.rola_polityka or "Uczestnik wystąpienia"
        ...
        masthead_table.setStyle(TableStyle([
            ("BACKGROUND", (0, 0), (-1, -1), c_slate_900),
